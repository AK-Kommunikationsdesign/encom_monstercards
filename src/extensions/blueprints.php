<?php return [ 'blocks/sitemonstercards' => function () {

    /* -------------- Config --------------*/
    $config       = pwConfig::load('sitemonstercards');
    ...
    $tabs = [];
		...
		$contentFields['blocks'] = [
			...
			'label'   => 'kirbyblock-monstercards.items',
			'fieldsets' => ['sitemonstercardsitem'],
		];
		...
		/* -------------- Layout Tab --------------*/
		pwConfig::addTab($tabs, 'layout', $tabSettings['layout'] ?? true, pwLayout::options('sitemonstercards', $defaults, [
		...
		/* -------------- Style Tab --------------*/
		pwConfig::addTab($tabs, 'style', $tabSettings['style'] ?? true, pwStyle::options('sitemonstercards', $defaults, [], $config['style'] ?? []));

		/* -------------- Grid Tab --------------*/
		pwConfig::addTab($tabs, 'grid', $tabSettings['grid'] ?? false, pwGrid::layout('sitemonstercards', $defaults));

		/* -------------- Settings Tab --------------*/
		pwConfig::addTab($tabs, 'settings', $tabSettings['settings'] ?? true, pwSettings::options('sitemonstercards', $defaults, [], $config['settings'] ?? []));

		/* -------------- Blueprint --------------*/
		return [
			'name'	=> 'kirbyblock-monstercards.name',
			'icon'  => 'monster',
			'tabs'	=> $tabs
		];
	},

	'blocks/sitemonstercardsitem' => function () {
