<template>
	<div
		...
		<pwBlockinfo
			:value="$t('kirbyblock-monstercards.name')"
			icon="monster"
		/>
						...
						<div v-for="item in blockItems"
							...
							<div class="pwContent">
								<div v-if="settings['item-tagline'] !== false">
									...
									<div class="placeholder" v-else>{{ $t('kirbyblock-monstercards.item.tagline.placeholder') }}</div>
								</div>
								<div v-if="settings['item-heading'] !== false">
									...
									<div class="placeholder" v-else>{{ $t('kirbyblock-monstercards.item.heading.placeholder') }}</div>
								</div>
